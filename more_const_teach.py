...
def main():
    ...
    plt.plot(tpr_s, fpr_s, (0, (5, 2)), label=f"Student KD HLT1 (AUC={auc_student_kd:.3f})", linewidth=2)
    plt.plot(tpr_ck, fpr_ck, (0, (3, 1, 1, 1)), label=f"Consistency+KD HLT{args.n_hlt_views} (AUC={auc_cons_kd:.3f})", linewidth=2)
