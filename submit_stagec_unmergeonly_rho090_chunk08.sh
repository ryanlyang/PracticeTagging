#!/usr/bin/env bash
# Submit Stage-C sweep chunk08 (4 runs).
set -euo pipefail
...
manifest="offline_reconstructor_logs/stagec_unmergeonly_rho090_chunk08_${stamp}.tsv"
...
echo "Submitting 4 Stage-C jobs for chunk08..."
submit_one 1.05 0.04 A 2e-5 1e-5 0.50
submit_one 1.05 0.04 B 3e-5 1.5e-5 0.60
submit_one 1.05 0.06 A 2e-5 1e-5 0.50
submit_one 1.05 0.06 B 3e-5 1.5e-5 0.60
