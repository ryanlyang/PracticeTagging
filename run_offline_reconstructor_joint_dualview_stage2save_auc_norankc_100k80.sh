...
# - Jet regressor OFF
#SBATCH --job-name=offrecoA100
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=3:00:00
#SBATCH --output=offline_reconstructor_logs/offline_reco_joint_auc100_%j.out
#SBATCH --error=offline_reconstructor_logs/offline_reco_joint_auc100_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs

RUN_NAME="${RUN_NAME:-joint_100k_80c_stage2save_auc_norankc}"
