...
#SBATCH --job-name=superres_mix
#SBATCH --output=superres_mix_logs/superres_mix_%j.out
#SBATCH --error=superres_mix_logs/superres_mix_%j.err
...
echo "=========================================="
echo "SuperRes Mixture (HLT -> SR -> Offline Classifier)"
echo "=========================================="
...
GEN_MIX_COMPONENTS=${GEN_MIX_COMPONENTS:-4}
...
# Locked KD/consistency hyperparameters (override only if you set env vars explicitly)
