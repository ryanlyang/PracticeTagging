...
# Low-LR Stage-C settings with lambda_reco=0.2 and lambda_cons=0.02.
#
...
#SBATCH --mem=48G
#SBATCH --time=1:30:00
#SBATCH --output=offline_reconstructor_logs/stagec_from_stage2_lowlr_r02_c002_%j.out
#SBATCH --error=offline_reconstructor_logs/stagec_from_stage2_lowlr_r02_c002_%j.err
...
RUN_NAME="${RUN_NAME:-stagec_refine_lowlr_lreco02_lcons002}"
