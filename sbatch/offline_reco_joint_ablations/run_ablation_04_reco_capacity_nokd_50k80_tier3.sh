...
#SBATCH --mem=64G
#SBATCH --time=1:30:00
#SBATCH --output=offline_reconstructor_logs/ablations/ab4_capacity_nokd_%j.out
#SBATCH --error=offline_reconstructor_logs/ablations/ab4_capacity_nokd_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/ablations

RUN_NAME="${RUN_NAME:-ab4_reco_capacity_nokd_50k_80c}"
