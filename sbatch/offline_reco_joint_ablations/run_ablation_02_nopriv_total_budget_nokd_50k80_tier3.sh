#!/usr/bin/env bash
#SBATCH --job-name=ab2NoPriv
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=1:30:00
#SBATCH --output=offline_reconstructor_logs/ablations/ab2_nopriv_nokd_%j.out
#SBATCH --error=offline_reconstructor_logs/ablations/ab2_nopriv_nokd_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/ablations

RUN_NAME="${RUN_NAME:-ab2_nopriv_total_budget_nokd_50k_80c}"
