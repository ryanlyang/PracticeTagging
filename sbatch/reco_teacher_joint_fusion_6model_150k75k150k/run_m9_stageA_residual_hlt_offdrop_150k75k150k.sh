#!/usr/bin/env bash
#SBATCH --job-name=m9off
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=10:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m9_stageA_offdrop_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m9_stageA_offdrop_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model9_stageA_residual_hlt_offdrop_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model9_stageA_residual_hlt_offdrop}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  ...
  # Teacher offline-dropout setup (new ablation)
  --teacher_use_offline_dropout
  --teacher_drop_prob_max 0.5
...
echo "============================================================"
echo "Model-9 StageA residual + offline-dropout teacher"
