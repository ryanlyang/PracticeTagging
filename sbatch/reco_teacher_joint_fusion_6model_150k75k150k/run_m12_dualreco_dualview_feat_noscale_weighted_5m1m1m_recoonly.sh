...
#SBATCH --requeue
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m12_dualreco_feat_noscale_recoonly_weighted_5m1m1m_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m12_dualreco_feat_noscale_recoonly_weighted_5m1m1m_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model12_dualreco_dualview_feat_noscale_weighted_5m1m1m_seed0_recoonly}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model12_dualreco_dualview_feat_noscale_weighted_5m1m1m_recoonly}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "Model-12 dual-reco dualview no_scale reco-only pretrain (weighted)"
