#!/usr/bin/env bash
#SBATCH --job-name=m6c100
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=9:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m6_concat_hltreco_fullscaleonly_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m6_concat_hltreco_fullscaleonly_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model6_concat_hltreco_stagea_concatjoint_fullscaleonly_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model6_concat_hltreco_stagea_concatjoint_fullscaleonly}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  ...
  --stageA_epochs 115
  --stageA_patience 18
  --stageA_phase035_epochs 0
  --stageA_phase070_epochs 0
  --stageA_kd_temp 2.5
...
echo "StageA curriculum override: skip phase_035 + phase_070, run phase_100 only"
echo "============================================================"
printf ' %q' "${CMD[@]}"
echo
"${CMD[@]}"
