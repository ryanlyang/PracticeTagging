...
sbatch --export=ALL,PROJECT_ROOT="${PROJECT_ROOT}" "${SCRIPT_DIR}/run_m36_k3_dict1m_retrieval_dualview_landmark11_150k75k300k.sh"

echo "Submitting Index B + learned HLT embedding index..."
sbatch --export=ALL,PROJECT_ROOT="${PROJECT_ROOT}" "${SCRIPT_DIR}/run_m36_k3_dict1m_retrieval_dualview_landmark11_learnedidx_150k75k300k.sh"
