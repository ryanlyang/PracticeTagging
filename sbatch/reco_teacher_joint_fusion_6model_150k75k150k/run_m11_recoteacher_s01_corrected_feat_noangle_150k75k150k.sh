#!/usr/bin/env bash
#SBATCH --job-name=m11ang
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=10:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m11_feat_noangle_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m11_feat_noangle_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model11_recoteacher_s01_corrected_feat_noangle_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model11_recoteacher_s01_corrected_feat_noangle}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  ...
  --seed "${SEED}"
  --teacher_feature_ablation no_angle
  --stageA_epochs 90
  --stageA_patience 18
  --stageA_kd_temp 2.5
...
echo "============================================================"
echo "Model-11 m4-style with teacher feature ablation: no_angle"
