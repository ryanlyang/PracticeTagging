...
M47_ANCHOR_RECO_CKPT="${M47_ANCHOR_RECO_CKPT:-${BASE_CKPT}/model9_stageA_residual_hlt_offdrop_mid_weighted_150k150k300k/model9_stageA_residual_hlt_offdrop_mid_weighted_150k150k300k_seed0/offline_reconstructor_A_stageA.pt}"
