...
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m2_joint_chamfer_budget_local_ptratio_unselected0_localr0_stagec_prog_wlocal025_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m2_joint_chamfer_budget_local_ptratio_unselected0_localr0_stagec_prog_wlocal025_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model2_joint_chamfer_budget_local_ptratio_unselected0_localr0_stagec_prog_wlocal025_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model2_joint_chamfer_budget_local_ptratio_unselected0_localr0_stagec_prog_wlocal025}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "Model-2 Joint (Chamfer+budget+local+pt_ratio; unselected/local-radius=0; Stage-C progressive unfreeze; w_local=0.25)"
