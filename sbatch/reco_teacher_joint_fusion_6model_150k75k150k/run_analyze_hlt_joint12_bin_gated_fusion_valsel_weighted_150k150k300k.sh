...
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/analyze12_bingated_valsel_weighted_150k150k300k_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/analyze12_bingated_valsel_weighted_150k150k300k_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

M2D005_RUN_DIR="${M2D005_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model2_joint_delta005_weighted_150k150k300k/model2_joint_delta005_weighted_150k150k300k_seed0}"
M2D020_RUN_DIR="${M2D020_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model2_joint_delta020_weighted_150k150k300k/model2_joint_delta020_weighted_150k150k300k_seed0}"
M4_RUN_DIR="${M4_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model4_recoteacher_s01_corrected_weighted_150k150k300k/model4_recoteacher_s01_corrected_weighted_150k150k300k_seed0}"
M5_RUN_DIR="${M5_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model5_joint_s01_full_weighted_150k150k300k/model5_joint_s01_full_weighted_150k150k300k_seed0}"
...
M9MID_RUN_DIR="${M9MID_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model9_stageA_residual_hlt_offdrop_mid_weighted_150k150k300k/model9_stageA_residual_hlt_offdrop_mid_weighted_150k150k300k_seed0}"
M9HIGH_RUN_DIR="${M9HIGH_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model9_stageA_residual_hlt_offdrop_high_weighted_150k150k300k/model9_stageA_residual_hlt_offdrop_high_weighted_150k150k300k_seed0}"
M12_RUN_DIR="${M12_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model12_dualreco_dualview_feat_noscale_weighted_150k150k300k/model12_dualreco_dualview_feat_noscale_weighted_150k150k300k_seed0}"
M15MID_RUN_DIR="${M15MID_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model15_dualreco_dualview_offdrop_mid_weighted_150k150k300k/model15_dualreco_dualview_offdrop_mid_weighted_150k150k300k_seed0}"
M15HIGH_RUN_DIR="${M15HIGH_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model15_dualreco_dualview_offdrop_high_weighted_150k150k300k/model15_dualreco_dualview_offdrop_high_weighted_150k150k300k_seed0}"
...
OUT_DIR="${OUT_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/bin_gated_fusion_12_weighted_150k150k300k_valsel}"
FUSION_JSON="${FUSION_JSON:-${OUT_DIR}/fusion_hlt_joint12_weighted_150k150k300k.json}"
...
echo "============================================================"
echo "12-Model Bin-Gated Fusion (Weighted 150k/150k/300k, Fine-Grained)"
