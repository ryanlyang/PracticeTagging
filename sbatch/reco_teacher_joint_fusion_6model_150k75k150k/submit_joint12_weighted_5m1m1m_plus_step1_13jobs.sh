...
j2a=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M2D005}" | awk '{print $4}')
j2b=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M2D020}" | awk '{print $4}')
j4=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M4}" | awk '{print $4}')
j5=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M5}" | awk '{print $4}')
j6=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M6}" | awk '{print $4}')
j9m=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M9MID}" | awk '{print $4}')
j9h=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M9HIGH}" | awk '{print $4}')
j12=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M12}" | awk '{print $4}')
j15m=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M15MID}" | awk '{print $4}')
j15h=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M15HIGH}" | awk '{print $4}')
j16=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M16}" | awk '{print $4}')
j17=$(sbatch --dependency="afterok:${jstep1}" --export=ALL,STEP1_LOAD_DIR="${STEP1_LOAD_DIR}" "${RUN_M17}" | awk '{print $4}')
...
echo "Dependency chain for analyze: afterok:${dep}"
