#!/usr/bin/env bash
#SBATCH --job-name=m6c0505
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=9:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m6_concat_hltreco_5x5_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m6_concat_hltreco_5x5_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model6_concat_hltreco_stagea_concatjoint_150k75k150k_seed0_phase5_5}"
...
CMD=(
  ...
  --stageA_epochs 115
  --stageA_patience 18
  --stageA_phase035_epochs 5
  --stageA_phase070_epochs 5
  --stageA_kd_temp 2.5
...
echo "============================================================"
echo "Model-6 concat(HLT+reco): short Stage-A curriculum 5/5"
