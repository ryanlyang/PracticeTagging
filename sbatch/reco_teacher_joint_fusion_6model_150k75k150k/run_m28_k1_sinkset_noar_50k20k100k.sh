...
RUN_NAME="${RUN_NAME:-model28_k1_sinkset_noar_50k20k100k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model28_sinkset_noar}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  python offline_reconstructor_joint_dualview_seq2seq_nexttoken_m28_sinkset_noar.py
  --save_dir "${SAVE_DIR}"
  --run_name "${RUN_NAME}"
