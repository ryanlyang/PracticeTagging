...
RUN_FINAL="${RUN_FINAL:-${SCRIPT_DIR}/run_m46_joint12_fusedstudent_recoonly_dual_joint_weighted_150k150k300k.sh}"
...
FINAL_RUN_NAME="${FINAL_RUN_NAME:-model46_joint12_fusedstudent_recoonly_dual_joint_weighted_150k150k300k_seed0}"
...
echo "============================================================"
echo "Queued Model-46 pipeline (fused-student Stage-A teacher + reco-only probe + dual+joint)"
