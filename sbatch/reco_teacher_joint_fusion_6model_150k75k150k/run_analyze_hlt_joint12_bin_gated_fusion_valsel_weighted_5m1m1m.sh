...
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/analyze12_bingated_valsel_weighted_5m1m1m_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/analyze12_bingated_valsel_weighted_5m1m1m_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

M2D005_RUN_DIR="${M2D005_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model2_joint_delta005_weighted_5m1m1m/model2_joint_delta005_weighted_5m1m1m_seed0}"
M2D020_RUN_DIR="${M2D020_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model2_joint_delta020_weighted_5m1m1m/model2_joint_delta020_weighted_5m1m1m_seed0}"
...
M5_RUN_DIR="${M5_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model5_joint_s01_full_weighted_5m1m1m/model5_joint_s01_full_weighted_5m1m1m_seed0}"
M6_RUN_DIR="${M6_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model6_concat_stagea_corrected_weighted_5m1m1m/model6_concat_stagea_corrected_weighted_5m1m1m_seed0}"
...
M12_RUN_DIR="${M12_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model12_dualreco_dualview_feat_noscale_weighted_5m1m1m/model12_dualreco_dualview_feat_noscale_weighted_5m1m1m_seed0}"
M15MID_RUN_DIR="${M15MID_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model15_dualreco_dualview_offdrop_mid_weighted_5m1m1m/model15_dualreco_dualview_offdrop_mid_weighted_5m1m1m_seed0}"
M15HIGH_RUN_DIR="${M15HIGH_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model15_dualreco_dualview_offdrop_high_weighted_5m1m1m/model15_dualreco_dualview_offdrop_high_weighted_5m1m1m_seed0}"
M16_RUN_DIR="${M16_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model16_dualreco_dualview_topk60_weighted_5m1m1m/model16_dualreco_dualview_topk60_weighted_5m1m1m_seed0}"
M17_RUN_DIR="${M17_RUN_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model17_dualreco_dualview_antioverlap_weighted_5m1m1m/model17_dualreco_dualview_antioverlap_weighted_5m1m1m_seed0}"
...
OUT_DIR="${OUT_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/bin_gated_fusion_12_weighted_5m1m1m_valsel}"
FUSION_JSON="${FUSION_JSON:-${OUT_DIR}/fusion_hlt_joint12_weighted_5m1m1m.json}"
