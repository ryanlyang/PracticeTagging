#!/usr/bin/env bash
#SBATCH --job-name=m42fg
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=18:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m42_joint12_fusedscore_stagea_teacher_weighted_150k150k300k_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m42_joint12_fusedscore_stagea_teacher_weighted_150k150k300k_%j.err
