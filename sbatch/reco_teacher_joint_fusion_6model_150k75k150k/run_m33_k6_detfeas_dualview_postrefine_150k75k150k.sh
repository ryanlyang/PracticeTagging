#!/usr/bin/env bash
#SBATCH --job-name=m33k6pr
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=72G
#SBATCH --time=7-00:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m33_k6_detfeas_dualview_postrefine_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m33_k6_detfeas_dualview_postrefine_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model33_k6_detfeas_dualview_postrefine_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model33_detfeas_dualview_postrefine}"
...
echo "============================================================"
echo "Model-33 K=6 Deterministic Feasibility + DualView (PostRefine ON)"
