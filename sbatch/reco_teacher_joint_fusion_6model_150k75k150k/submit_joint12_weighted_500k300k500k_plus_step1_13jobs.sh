...
RUN_STEP1="${ROOT}/run_teacher_hlt_only_500k300k500k.sh"
RUN_M2D005="${ROOT}/run_m2_joint_delta005_weighted_500k300k500k.sh"
RUN_M2D020="${ROOT}/run_m2_joint_delta020_weighted_500k300k500k.sh"
RUN_M4="${ROOT}/run_m4_recoteacher_s01_corrected_weighted_500k300k500k.sh"
RUN_M5="${ROOT}/run_m5_joint_s01_full_weighted_500k300k500k.sh"
RUN_M6="${ROOT}/run_m6_concat_stagea_corrected_weighted_500k300k500k.sh"
RUN_M9MID="${ROOT}/run_m9_stageA_residual_hlt_offdrop_mid_weighted_500k300k500k.sh"
RUN_M9HIGH="${ROOT}/run_m9_stageA_residual_hlt_offdrop_high_weighted_500k300k500k.sh"
RUN_M12="${ROOT}/run_m12_dualreco_dualview_feat_noscale_weighted_500k300k500k.sh"
RUN_M15MID="${ROOT}/run_m15_dualreco_dualview_offdrop_mid_weighted_500k300k500k.sh"
RUN_M15HIGH="${ROOT}/run_m15_dualreco_dualview_offdrop_high_weighted_500k300k500k.sh"
...
STEP1_REF_NPZ="${STEP1_REF_NPZ:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/teacher_hlt_only_weighted_500k300k500k/teacher_hlt_only_weighted_500k300k500k_seed0/results_step1_teacher_baseline.npz}"
