#!/usr/bin/env bash
#SBATCH --job-name=m26k1s4
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=1-00:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m26_k1_sinkhorn4_bs80_50k20k100k_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m26_k1_sinkhorn4_bs80_50k20k100k_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model26_k1_sinkhorn4_bs80_50k20k100k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model26_sinkhorn4}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  python offline_reconstructor_joint_dualview_seq2seq_nexttoken_m26_sinkhorn4.py
  --save_dir "${SAVE_DIR}"
  --run_name "${RUN_NAME}"
...
echo "============================================================"
echo "Model-26 K=1 Sinkhorn4 NoMicro FR (Batch80)"
