#!/usr/bin/env bash
#SBATCH --job-name=m37dret
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=1-00:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m37_k3_dict1m_multicand_dualview_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m37_k3_dict1m_multicand_dualview_%j.err

set -euo pipefail

RUN_NAME="${RUN_NAME:-model37_k3_dict1m_multicand_dualview_150k75k300k_seed0}"
SAVE_DIR="${SAVE_DIR:-}"
...
echo "============================================================"
echo "Model-37 K=3 MultiCandidate Dictionary DualView"
