#!/usr/bin/env bash
#SBATCH --job-name=m13d2c
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=16:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m13_dualreco_feat_coreshape_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m13_dualreco_feat_coreshape_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model13_dualreco_dualview_feat_coreshape_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model13_dualreco_dualview_feat_coreshape}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  ...
  --target_feature_ablation core_shape
...
echo "============================================================"
echo "Model-13 dual-reco dualview feature-ablation: core_shape"
