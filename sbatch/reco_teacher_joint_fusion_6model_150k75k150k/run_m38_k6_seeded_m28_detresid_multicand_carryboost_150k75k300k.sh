#!/usr/bin/env bash
#SBATCH --job-name=m38k6cb
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=16-00:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m38_k6_seeded_m28_detresid_multicand_carryboost_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m38_k6_seeded_m28_detresid_multicand_carryboost_%j.err

set -euo pipefail

RUN_NAME="${RUN_NAME:-model38_k6_seeded_m28_detresid_multicand_carryboost_150k75k300k_seed0}"
SAVE_DIR="${SAVE_DIR:-}"
...
echo "============================================================"
echo "Model-38 K=6 Seeded-m28 + Deterministic-Residual MultiCandidate (CarryBoost)"
