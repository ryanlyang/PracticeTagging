...
RUN_STEP1="${ROOT}/run_teacher_hlt_only_150k150k300k.sh"
RUN_M2D005="${ROOT}/run_m2_joint_delta005_weighted_150k150k300k.sh"
RUN_M2D020="${ROOT}/run_m2_joint_delta020_weighted_150k150k300k.sh"
RUN_M4="${ROOT}/run_m4_recoteacher_s01_corrected_weighted_150k150k300k.sh"
RUN_M5="${ROOT}/run_m5_joint_s01_full_weighted_150k150k300k.sh"
RUN_M6="${ROOT}/run_m6_concat_stagea_corrected_weighted_150k150k300k.sh"
RUN_M9MID="${ROOT}/run_m9_stageA_residual_hlt_offdrop_mid_weighted_150k150k300k.sh"
RUN_M9HIGH="${ROOT}/run_m9_stageA_residual_hlt_offdrop_high_weighted_150k150k300k.sh"
RUN_M12="${ROOT}/run_m12_dualreco_dualview_feat_noscale_weighted_150k150k300k.sh"
RUN_M15MID="${ROOT}/run_m15_dualreco_dualview_offdrop_mid_weighted_150k150k300k.sh"
RUN_M15HIGH="${ROOT}/run_m15_dualreco_dualview_offdrop_high_weighted_150k150k300k.sh"
...
RUN_ANALYZE="${ROOT}/run_analyze_hlt_joint12_bin_gated_fusion_valsel_weighted_150k150k300k.sh"
