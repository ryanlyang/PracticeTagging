#!/usr/bin/env bash
#SBATCH --job-name=m39sp5m
#SBATCH --partition=tier3
#SBATCH --gres=gpu:a100:1
#SBATCH --mem=128G
#SBATCH --time=5-00:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m39_prefixspecialist_detresid_multicand_5m1m1m_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m39_prefixspecialist_detresid_multicand_5m1m1m_%j.err

set -euo pipefail

RUN_NAME="${RUN_NAME:-model39_prefixspecialist_detresid_multicand_5m1m1m_seed0}"
SAVE_DIR="${SAVE_DIR:-}"
...
RECO_BATCH_SIZE="${RECO_BATCH_SIZE:-64}"
...
if [[ -z "${SAVE_DIR}" ]]; then
  SAVE_DIR="${REPO_ROOT}/checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model39_prefixspecialist_detresid_multicand_5m1m1m"
fi
...
echo "============================================================"
echo "Model-39 Prefix-Specialist + Deterministic-Residual MultiCandidate (5M/1M/1M)"
