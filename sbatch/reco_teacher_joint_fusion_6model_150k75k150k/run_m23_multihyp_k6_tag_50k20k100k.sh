#!/usr/bin/env bash
#SBATCH --job-name=m23k6tag
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=40G
#SBATCH --time=2-12:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m23_k6_tag_50k20k100k_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m23_k6_tag_50k20k100k_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model23_multihyp_k6_tag_50k20k100k_seed0}"
...
echo "============================================================"
echo "Model-23 MultiHyp K=6 (winner=tag)"
