#!/usr/bin/env bash
#SBATCH --job-name=m30k6s
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=12:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m30_k6_jetlatent_ctxselector_selectoronly_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m30_k6_jetlatent_ctxselector_selectoronly_%j.err

set -euo pipefail
mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model30_k6_jetlatent_ctxselector_selectoronly_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model30_k6_jetlatent_ctxselector_selectoronly}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "Model-30 K=6 jetlatent contextual selector routing (StageC selector_only)"
printf ' %q' "${CMD[@]}"; echo
"${CMD[@]}"
