#!/usr/bin/env bash
#SBATCH --job-name=m30k6a
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=24:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m30_k6_jetlatent_ctxselector_allthree_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m30_k6_jetlatent_ctxselector_allthree_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model30_k6_jetlatent_ctxselector_allthree_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model30_k6_jetlatent_ctxselector_allthree}"
...
echo "============================================================"
echo "Model-30 K=6 jetlatent contextual selector routing (StageC all_three)"
