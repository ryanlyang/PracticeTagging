#!/usr/bin/env bash
#SBATCH --job-name=m39s2p6
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=8-00:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m39_prefix6_stage2_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m39_prefix6_stage2_%j.err

set -euo pipefail

RUN_NAME="${RUN_NAME:-model39_prefix6_stage2_150k75k300k_seed0}"
SAVE_DIR="${SAVE_DIR:-}"
...
STAGE1_SAVE_DIR="${STAGE1_SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model39_prefixspecialist_detresid_multicand}"
STAGE1_RUN_NAMES="${STAGE1_RUN_NAMES:-model39_prefixspecialist_detresid_multicand_150k75k300k_seed0_pfx0,model39_prefixspecialist_detresid_multicand_150k75k300k_seed0_pfx3,model39_prefixspecialist_detresid_multicand_150k75k300k_seed0_pfx6,model39_prefixspecialist_detresid_multicand_150k75k300k_seed0_pfx9,model39_prefixspecialist_detresid_multicand_150k75k300k_seed0_pfx12,model39_prefixspecialist_detresid_multicand_150k75k300k_seed0_pfx15}"
...
if [[ -z "${SAVE_DIR}" ]]; then
  SAVE_DIR="${REPO_ROOT}/checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model39_prefix6_stage2"
fi
...
echo "============================================================"
echo "Model-39 Prefix6 Stage2 (single final top tagger)"
