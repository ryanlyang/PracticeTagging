#!/usr/bin/env bash
#SBATCH --job-name=m2ormarg
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=24G
#SBATCH --time=02:00:00
#SBATCH --output=offline_reconstructor_logs/reco_oracle_study_6model_150k75k150k/m2_diag_oracle_marginal_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_oracle_study_6model_150k75k150k/m2_diag_oracle_marginal_%j.err
...
DEFAULT_RUN_SUBPATH="reco_teacher_joint_fusion_6model_150k75k150k/model2_joint_delta005_fulltrain_prog_unfreeze_oracle_study/model2_joint_delta005_fulltrain_prog_unfreeze_oracle_${ORACLE_VARIANT}_150k75k150k_seed0"
...
CMD=(
  ...
  --gate_c "${GATE_C}"
  --out_dir "${OUT_DIR}"
  --report_json "${OUT_DIR}/${SPLIT}_marginal_signal_report_oracle_${ORACLE_VARIANT}.json"
)
...
echo "============================================================"
echo "M2 Oracle-Study Marginal Signal Diagnostic"
echo "Variant:      ${ORACLE_VARIANT}"
...
echo
echo "Done. Outputs:"
echo "  ${OUT_DIR}/${SPLIT}_marginal_signal_report_oracle_${ORACLE_VARIANT}.json"
