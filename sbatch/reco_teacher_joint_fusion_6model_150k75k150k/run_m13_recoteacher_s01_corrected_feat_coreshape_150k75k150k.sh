#!/usr/bin/env bash
#SBATCH --job-name=m13shp
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=10:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m13_feat_coreshape_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m13_feat_coreshape_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model13_recoteacher_s01_corrected_feat_coreshape_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model13_recoteacher_s01_corrected_feat_coreshape}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
CMD=(
  ...
  --seed "${SEED}"
  --teacher_feature_ablation core_shape
  --stageA_epochs 90
  --stageA_patience 18
  --stageA_kd_temp 2.5
...
echo "============================================================"
echo "Model-13 m4-style with teacher feature ablation: core_shape"
