#!/usr/bin/env bash
#SBATCH --job-name=m29k6s
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=12:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m29_k6_jetlatent_selector_selectoronly_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k/m29_k6_jetlatent_selector_selectoronly_%j.err

set -euo pipefail
mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_150k75k150k

RUN_NAME="${RUN_NAME:-model29_k6_jetlatent_selector_selectoronly_150k75k150k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_150k75k150k/model29_k6_jetlatent_selector_selectoronly}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "Model-29 K=6 jetlatent selector routing (StageC selector_only)"
printf ' %q' "${CMD[@]}"; echo
"${CMD[@]}"
