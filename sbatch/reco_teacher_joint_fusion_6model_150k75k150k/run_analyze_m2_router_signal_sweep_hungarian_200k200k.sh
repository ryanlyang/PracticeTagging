...
mkdir -p offline_reconstructor_logs/reco_router_signal_sweep_6model_200k200k
...
TOP_PAIR_SIGNAL_K="${TOP_PAIR_SIGNAL_K:-6}"

OUT_DIR="${OUT_DIR:-${RUN_DIR}/router_signal_sweep_200k200k}"
...
echo "============================================================"
echo "M2 Router Signal Sweep (Hungarian run, 200k analysis + 200k test)"
