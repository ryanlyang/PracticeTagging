...
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_300k100k300k/m4_corrected_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_300k100k300k/m4_corrected_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_300k100k300k

RUN_NAME="${RUN_NAME:-model4_recoteacher_s01_corrected_300k100k300k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_300k100k300k/model4_recoteacher_s01_corrected}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
