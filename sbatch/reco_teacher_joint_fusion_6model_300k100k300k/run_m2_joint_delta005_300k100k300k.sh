#!/usr/bin/env bash
#SBATCH --job-name=m2j300
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=1-12:00:00
#SBATCH --output=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_300k100k300k/m2_joint_%j.out
#SBATCH --error=offline_reconstructor_logs/reco_teacher_joint_fusion_6model_300k100k300k/m2_joint_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs/reco_teacher_joint_fusion_6model_300k100k300k

RUN_NAME="${RUN_NAME:-model2_joint_delta005_300k100k300k_seed0}"
SAVE_DIR="${SAVE_DIR:-checkpoints/reco_teacher_joint_fusion_6model_300k100k300k/model2_joint_delta}"
SEED="${SEED:-0}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "Model-2 Joint (weak L_delta=0.05)"
