#!/usr/bin/env bash
#SBATCH --job-name=sA03sem
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=36:00:00
#SBATCH --output=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s03_sem_heavy_%j.out
#SBATCH --error=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s03_sem_heavy_%j.err

set -euo pipefail
mkdir -p offline_reconstructor_logs/stageA_teacher_auc_sweep10

export RUN_NAME="joint_stageA_sweep10_s03_semantic_heavy_seed0"
...
export STAGEA_LAMBDA_EMB=2.0
export STAGEA_LAMBDA_TOK=1.2
