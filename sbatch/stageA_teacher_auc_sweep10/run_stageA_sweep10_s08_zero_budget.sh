#!/usr/bin/env bash
#SBATCH --job-name=sA08nob
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=36:00:00
#SBATCH --output=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s08_nobudget_%j.out
#SBATCH --error=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s08_nobudget_%j.err

set -euo pipefail
mkdir -p offline_reconstructor_logs/stageA_teacher_auc_sweep10

export RUN_NAME="joint_stageA_sweep10_s08_zero_budget_seed0"
...
export STAGEA_LAMBDA_KD=1.2
export STAGEA_LAMBDA_EMB=1.4
export STAGEA_LAMBDA_TOK=0.8
export STAGEA_LAMBDA_PHYS=0.25
export STAGEA_LAMBDA_BUDGET_HINGE=0.0
