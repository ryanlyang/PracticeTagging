...
#SBATCH --error=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s02_kd_dom_%j.err
...
export STAGEA_LAMBDA_KD=2.5
export STAGEA_LAMBDA_EMB=0.6
export STAGEA_LAMBDA_TOK=0.3
