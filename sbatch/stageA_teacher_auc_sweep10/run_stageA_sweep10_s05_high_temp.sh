#!/usr/bin/env bash
#SBATCH --job-name=sA05T4
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=36:00:00
#SBATCH --output=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s05_T4_%j.out
#SBATCH --error=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s05_T4_%j.err

set -euo pipefail
mkdir -p offline_reconstructor_logs/stageA_teacher_auc_sweep10

export RUN_NAME="joint_stageA_sweep10_s05_high_temp_seed0"
...
export STAGEA_KD_TEMP=4.0
export STAGEA_LAMBDA_KD=1.5
