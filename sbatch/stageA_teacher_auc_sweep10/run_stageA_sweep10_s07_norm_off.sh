#!/usr/bin/env bash
#SBATCH --job-name=sA07raw
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=96G
#SBATCH --time=36:00:00
#SBATCH --output=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s07_normoff_%j.out
#SBATCH --error=offline_reconstructor_logs/stageA_teacher_auc_sweep10/s07_normoff_%j.err

set -euo pipefail
mkdir -p offline_reconstructor_logs/stageA_teacher_auc_sweep10

export RUN_NAME="joint_stageA_sweep10_s07_norm_off_seed0"
...
export DISABLE_STAGEA_LOSS_NORMALIZATION=1
