#!/usr/bin/env bash
# Stage-C sweep suite debug_1 (lambda_cons down sweep).
#
# Submit:
#   sbatch sbatch/stagec_from_stage2_sweeps/run_stagec_sweep_debug_1.sh
#
# Optional overrides:
#   RUN_DIR=... SAVE_DIR=... N_TRAIN_JETS=... MAX_CONSTITS=... SEED=...
#
#SBATCH --job-name=stgSwD1
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=04:00:00
#SBATCH --output=offline_reconstructor_logs/stagec_sweep_debug1_%j.out
#SBATCH --error=offline_reconstructor_logs/stagec_sweep_debug1_%j.err
