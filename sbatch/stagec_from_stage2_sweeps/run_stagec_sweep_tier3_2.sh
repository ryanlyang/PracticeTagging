#!/usr/bin/env bash
# Stage-C sweep suite tier3_2 (high lambda_reco cross-checks).
#
# Submit:
#   sbatch sbatch/stagec_from_stage2_sweeps/run_stagec_sweep_tier3_2.sh
#
#SBATCH --job-name=stgSwT2
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=04:00:00
#SBATCH --output=offline_reconstructor_logs/stagec_sweep_tier32_%j.out
#SBATCH --error=offline_reconstructor_logs/stagec_sweep_tier32_%j.err
