...
#SBATCH --job-name=smartres
#SBATCH --output=smartres_logs/smartres_%j.out
#SBATCH --error=smartres_logs/smartres_%j.err
...
echo "=========================================="
echo "SmartRes (Flow SR Generator)"
echo "=========================================="
...
GEN_FLOW_LAYERS=${GEN_FLOW_LAYERS:-6}
GEN_FLOW_HIDDEN=${GEN_FLOW_HIDDEN:-128}
GEN_FLOW_SCALE=${GEN_FLOW_SCALE:-0.8}
GEN_LR=${GEN_LR:-5e-4}
...
CMD="python SmartRes.py \
    ...
    --gen_flow_layers $GEN_FLOW_LAYERS \
    --gen_flow_hidden $GEN_FLOW_HIDDEN \
    --gen_flow_scale $GEN_FLOW_SCALE \
    --gen_lr $GEN_LR \
