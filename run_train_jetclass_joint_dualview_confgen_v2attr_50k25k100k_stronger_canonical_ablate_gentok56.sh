#!/usr/bin/env bash
#SBATCH --job-name=jcCnfA2
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_50k25k100k_stronger_canonical_ablate_gentok56_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_50k25k100k_stronger_canonical_ablate_gentok56_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_confgen_v2attr_50k25k100k_stronger_canonical_ablate_gentok56}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
