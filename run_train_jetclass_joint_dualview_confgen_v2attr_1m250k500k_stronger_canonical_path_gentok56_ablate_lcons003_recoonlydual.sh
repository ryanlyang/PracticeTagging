...
RUN_NAME="${RUN_NAME:-jetclass_joint_confgen_v2attr_1m250k500k_stronger_canonical_path_gentok56_ablate_lcons003_recoonlydual}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
...
N_TEST_JETS="${N_TEST_JETS:-500000}"
