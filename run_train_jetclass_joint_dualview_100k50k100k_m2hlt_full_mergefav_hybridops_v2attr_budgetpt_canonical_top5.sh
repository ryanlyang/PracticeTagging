#!/usr/bin/env bash
#SBATCH --job-name=jcHybV2T5
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
#SBATCH --time=1-00:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_full_mergefav_hybridops_v2attr_budgetpt_canonical_top5_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_full_mergefav_hybridops_v2attr_budgetpt_canonical_top5_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v2attr_100k50k100k_m2hlt_full_mergefav_hybridops_budgetpt_canonical_top5}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
