#!/usr/bin/env bash
#SBATCH --job-name=jcG56R25R
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_50k25k100k_stronger_canonical_path_gentok56_ablate_lreco025_recoonlydual_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_50k25k100k_stronger_canonical_path_gentok56_ablate_lreco025_recoonlydual_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_confgen_v2attr_50k25k100k_stronger_canonical_path_gentok56_ablate_lreco025_recoonlydual}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
