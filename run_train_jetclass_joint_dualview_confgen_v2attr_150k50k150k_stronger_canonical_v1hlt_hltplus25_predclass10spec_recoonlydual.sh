#!/usr/bin/env bash
#SBATCH --job-name=jcSp10R1
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=96G
#SBATCH --time=24:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_150k50k150k_stronger_canonical_v1hlt_hltplus25_predclass10spec_recoonlydual_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_150k50k150k_stronger_canonical_v1hlt_hltplus25_predclass10spec_recoonlydual_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_confgen_v2attr_150k50k150k_stronger_canonical_v1hlt_hltplus25_predclass10spec_recoonlydual}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
...
# Use the default v1/v2 HLT builder path in wrapper
...
CMD=(
  ...
  --specialist_num_experts 10
  --specialist_min_train_samples 1200
  --specialist_min_val_samples 300
  --specialist_finetune_epochs 8
  --specialist_finetune_patience 3
  --specialist_finetune_lr_scale 0.50
  --specialist_route_min_conf 0.00
...
echo "============================================================"
echo "JetClass Joint Dual-View V2 (confgen + v1HLT+25 + predicted-class 10 specialists)"
