#!/usr/bin/env bash
#SBATCH --job-name=jcM2HG1M
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=256G
#SBATCH --time=5-00:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_v2attr_1m250k1m_m2hlt_hybridops_adaptivegen_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_v2attr_1m250k1m_m2hlt_hybridops_adaptivegen_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v2attr_1m250k1m_m2hlt_hybridops_adaptivegen_sps001}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
