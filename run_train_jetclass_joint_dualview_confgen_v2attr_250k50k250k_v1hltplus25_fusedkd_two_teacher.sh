...
TEACHER_A_RUN="${TEACHER_A_RUN:-checkpoints/jetclass_joint_dualview/jetclass_joint_confgen_v2attr_50k25k100k_tier3_teacherA_lcons003_recoonlydual}"
TEACHER_B_RUN="${TEACHER_B_RUN:-checkpoints/jetclass_joint_dualview/jetclass_joint_confgen_v2attr_50k25k100k_tier3_teacherB_v1hltplus25_gentok56}"
