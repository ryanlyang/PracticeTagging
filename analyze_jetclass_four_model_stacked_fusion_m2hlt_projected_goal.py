#!/usr/bin/env python3
"""Run JetClass stacked-fusion analyzer with m2 HLT and projected-goal hybrid reconstructor."""
...
def main() -> None:
    ...
    fusion.hybrid_ops.OfflineReconstructorHybridOps = projected_goal_hybrid.OfflineReconstructorProjectedGoalHybridOps
    fusion.hybrid_ops.build_soft_corrected_view_hybrid_ops = projected_goal_hybrid.build_soft_corrected_view_hybrid_ops
    fusion.main()
