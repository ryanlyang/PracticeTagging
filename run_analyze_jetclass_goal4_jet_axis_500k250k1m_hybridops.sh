...
#SBATCH --mem=96G
#SBATCH --time=2:55:00
#SBATCH --output=offline_reconstructor_logs/jetclass_goal4_jet_axis_500k250k1m_hybridops_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_goal4_jet_axis_500k250k1m_hybridops_%j.err
...
OUT_DIR="${OUT_DIR:-${SAVE_ROOT}/axis_reports/goal4_500k250k1m_hybridops_jet_axis_fast100k}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "JetClass Goal4 Jet-Axis Recovery (500k/250k/1m hybridops-goal)"
