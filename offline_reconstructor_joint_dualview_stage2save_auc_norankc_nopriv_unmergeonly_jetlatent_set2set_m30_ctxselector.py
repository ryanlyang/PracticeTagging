...
"""
m30: Jet-latent set2set + contextual K-hypothesis selector routing.

Built as a fork over the m2 jet-latent wrapper:
- keeps the same base m2 A/B/C pipeline,
- adds K-hypothesis reconstructor outputs (default K=6),
- trains a contextual selector over (HLT context + per-hypothesis reco context),
