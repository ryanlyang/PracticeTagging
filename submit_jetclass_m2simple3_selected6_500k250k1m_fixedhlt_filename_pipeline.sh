...
# Queues six selected fixed-HLT m2-simple3 variants, then a dependent stacked
...
RUNNER_FUSION="${RUNNER_FUSION:-run_analyze_jetclass_six_model_stacked_fusion_500k250k1m_m2simple3_selected6.sh}"
...
CORE08="jetclass_joint_v2attr_500k250k1m_m2hlt_simple3ops_${TAG}_core08_reassignstrong"
...
OUT_DIR="${OUT_DIR:-${SAVE_DIR}/fusion_reports/six_model_500k250k1m_m2simple3_selected6_${TAG}_stacked_acc}"
...
echo "Submitting selected-6 fixed-HLT JetClass m2-simple3 500k/250k/1M pipeline on ${PARTITION}"
...
echo "============================================================"
echo "Queued selected-6 fixed-HLT JetClass m2-simple3 pipeline"
