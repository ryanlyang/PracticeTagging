...
MODEL_07_SPEC="${MODEL_07_SPEC:-fkd_base:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core07_fkd_base}"
MODEL_08_SPEC="${MODEL_08_SPEC:-fkd_noreco:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core08_fkd_noreco}"
MODEL_09_SPEC="${MODEL_09_SPEC:-fkd_recostrong:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core09_fkd_recostrong}"
MODEL_10_SPEC="${MODEL_10_SPEC:-fkd_kdstrong:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core10_fkd_kdstrong}"
MODEL_11_SPEC="${MODEL_11_SPEC:-fkd_wA03:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core11_fkd_wA03}"
MODEL_12_SPEC="${MODEL_12_SPEC:-fkd_wA07:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core12_fkd_wA07}"
MODEL_13_SPEC="${MODEL_13_SPEC:-fkd_temp3:stage2:${SAVE_ROOT}/jetclass_joint_confgen_v2attr_250k50k250k_v1hltplus25_core13_fkd_temp3}"
