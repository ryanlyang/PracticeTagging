#!/usr/bin/env bash
#SBATCH --job-name=jc12F1M
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=160G
#SBATCH --time=5-00:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_twelve_model_stacked_fusion_1m250k1m_m2hybrid_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_twelve_model_stacked_fusion_1m250k1m_m2hybrid_%j.err
...
OUT_DIR="${OUT_DIR:-${SAVE_ROOT}/fusion_reports/twelve_model_1m250k1m_m2hybrid_stacked_acc}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "JetClass Twelve-Model Stacked Fusion (1m/250k/1m m2-hybrid setup)"
