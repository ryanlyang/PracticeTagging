#!/usr/bin/env bash
#SBATCH --job-name=jcJLatFC
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=23:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_fullinput_mergefav_jetlatent_fullbudget_canonical_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_fullinput_mergefav_jetlatent_fullbudget_canonical_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v1_100k50k100k_m2hlt_fullinput_mergefav_jetlatent_fullbudget_canonical}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
