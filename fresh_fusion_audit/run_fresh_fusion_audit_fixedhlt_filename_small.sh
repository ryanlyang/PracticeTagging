...
#SBATCH --mem=160G
#SBATCH --gres=gpu:1
#SBATCH --output=offline_reconstructor_logs/fresh_fusion_audit_fixedhlt_filename_small_%j.out
#SBATCH --error=offline_reconstructor_logs/fresh_fusion_audit_fixedhlt_filename_small_%j.err
...
OUT_DIR="${OUT_DIR:-${ROOT}/fusion_reports/fresh_audit_fixedhlt_filename_small_50k20k100k}"
...
echo "============================================================"
echo "Fresh fusion audit: fixed-HLT filename SMALL"
