...
#SBATCH --mem=160G
#SBATCH --gres=gpu:1
#SBATCH --output=offline_reconstructor_logs/fresh_fusion_audit_simple3ops_selected5_small_%j.out
#SBATCH --error=offline_reconstructor_logs/fresh_fusion_audit_simple3ops_selected5_small_%j.err
...
OUT_DIR="${OUT_DIR:-${ROOT}/fusion_reports/fresh_audit_simple3ops_selected5_small_50k20k100k}"

STACK_TRAIN_JETS="${STACK_TRAIN_JETS:-50000}"
STACK_VAL_JETS="${STACK_VAL_JETS:-20000}"
FINAL_TEST_JETS="${FINAL_TEST_JETS:-100000}"
...
echo "============================================================"
echo "Fresh fusion audit: simple3ops selected5 SMALL"
