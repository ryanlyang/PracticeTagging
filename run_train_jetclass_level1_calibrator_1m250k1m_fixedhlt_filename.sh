...
HLT_BUILDER="${HLT_BUILDER:-m2}"

# Same fixed-HLT profile as the current fixedhlt_filename 12-model pipeline.
...
echo "============================================================"
echo "JetClass Level-1 Jet Calibrator"
echo "Job ID: ${SLURM_JOB_ID:-manual}"
echo "Node: ${SLURMD_NODENAME:-unknown}"
echo "Data dir: ${DATA_DIR}"
echo "Out dir:  ${OUT_DIR}"
echo "Jets:     train=${N_TRAIN_JETS} val=${N_VAL_JETS} test=${N_TEST_JETS}"
echo "HLT:      builder=${HLT_BUILDER} fixed profile, seed=${SEED}"
echo "============================================================"
