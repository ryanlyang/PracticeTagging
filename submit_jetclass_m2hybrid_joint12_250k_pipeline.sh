...
# Queues 12 JetClass m2-hybrid adaptive-generation variants at 250k/50k/250k,
...
RUNNER_FUSION="${RUNNER_FUSION:-run_analyze_jetclass_twelve_model_stacked_fusion_250k_m2hybrid.sh}"

for f in "${RUNNER_TRAIN}" "${RUNNER_FUSION}"; do
  [[ -f "${f}" ]] || { echo "Missing runner: ${f}" >&2; exit 1; }
done

CORE01="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core01_base"
CORE02="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core02_consstrong"
CORE03="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core03_budgetlite"
CORE04="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core04_genlow"
CORE05="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core05_genhigh"
CORE06="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core06_splitstrong"
CORE07="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core07_splitlight"
CORE08="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core08_reassignstrong"
CORE09="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core09_offdropmid"
CORE10="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core10_offdrophigh"
CORE11="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core11_topk60ish"
CORE12="jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_core12_antioverlap"

OUT_DIR="${OUT_DIR:-${SAVE_DIR}/fusion_reports/twelve_model_250k_m2hybrid_stacked_acc}"
OPTIMIZE_FOR="${OPTIMIZE_FOR:-acc}"

COMMON_EXPORT="SAVE_DIR=${SAVE_DIR},N_TRAIN_JETS=250000,N_VAL_JETS=50000,N_TEST_JETS=250000,FEATURE_PREPROCESSING=canonical,CLASS_ASSIGNMENT=canonical_labels,TARGET_CLASS=Hbb,BACKGROUND_CLASS=QCD"
...
echo "Submitting JetClass 12-runner m2-hybrid pipeline on ${PARTITION} (time=${TIME_LIMIT})"
...
echo "============================================================"
echo "Queued JetClass 12-runner m2-hybrid pipeline"
