#!/usr/bin/env bash
#SBATCH --job-name=jcM2HGA
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=3-00:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v2attr_250k50k250k_m2hlt_hybridops_adaptivegen_sps001}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "JetClass m2-style hybrid reconstructor (adaptive split/gen budget)"
