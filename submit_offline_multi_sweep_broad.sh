...
# Broad A2 sweep for Offline_multi.py (120 runs)
#
# Block A (96 runs): student/KD hyperparameters
#   K_SAMPLES: 8, 16, 32
#   KD_TEMP: 2.5, 3.0, 3.5, 4.0
#   A_KD: 0.5, 0.7, 0.9, 1.0
#   BETA_ALL: 0.0, 0.1
#
# Block B (24 runs): generator hyperparameters
#   GEN_MIN_SIGMA: 0.01, 0.02
#   GEN_LAMBDA_MASK: 0.5, 1.0, 2.0
#   GEN_LAMBDA_PERC: 0.5, 1.0
#   GEN_LAMBDA_LOGIT: 0.25, 0.5

SAVE_DIR=${SAVE_DIR:-"checkpoints/offline_multi_sweep_broad"}
...
echo "Block A: student/KD hyperparameters (96 runs)"
K_SAMPLES_LIST=(8 16 32)
KD_TEMP_LIST=(2.5 3.0 3.5 4.0)
A_KD_LIST=(0.5 0.7 0.9 1.0)
...
echo "Block B: generator hyperparameters (24 runs)"
GEN_MIN_SIGMA_LIST=(0.01 0.02)
GEN_LAMBDA_MASK_LIST=(0.5 1.0 2.0)
