...
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_v2attr_500k250k1m_m2hlt_hybridops_projected_goal_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_v2attr_500k250k1m_m2hlt_hybridops_projected_goal_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v2attr_500k250k1m_m2hlt_hybridops_projected_goal_sps001}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
