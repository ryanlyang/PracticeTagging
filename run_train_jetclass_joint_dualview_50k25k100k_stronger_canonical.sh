#!/usr/bin/env bash
#SBATCH --job-name=jcJv1SmC
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=1-12:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_50k25k100k_stronger_canonical_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_50k25k100k_stronger_canonical_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v1_50k25k100k_stronger_canonical}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
