#!/usr/bin/env bash
#SBATCH --job-name=jcJv1M2
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=23:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v1_100k50k100k_m2hlt}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "JetClass Joint Dual-View V1 (m2-style HLT, dominant-token merge copy)"
