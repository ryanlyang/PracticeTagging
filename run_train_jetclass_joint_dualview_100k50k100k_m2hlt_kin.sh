#!/usr/bin/env bash
#SBATCH --job-name=jcJv1M2K
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --time=23:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_kin_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_100k50k100k_m2hlt_kin_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_v1_100k50k100k_m2hlt_kin}"
SEED="${SEED:-52}"
DEVICE="${DEVICE:-cuda}"
...
echo "============================================================"
echo "JetClass Joint Dual-View V1 (m2hlt, kin-only isolate)"
