#!/usr/bin/env bash
# Submit Stage-C sweep chunk03 (4 runs).
set -euo pipefail
...
manifest="offline_reconstructor_logs/stagec_unmergeonly_rho090_chunk03_${stamp}.tsv"
...
echo "Submitting 4 Stage-C jobs for chunk03..."
submit_one 0.95 0.00 A 2e-5 1e-5 0.50
submit_one 0.95 0.00 B 3e-5 1.5e-5 0.60
submit_one 0.95 0.02 A 2e-5 1e-5 0.50
submit_one 0.95 0.02 B 3e-5 1.5e-5 0.60
