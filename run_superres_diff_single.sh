...
echo "=========================================="
echo "SuperResDiff (Probabilistic SR + KD)"
echo "=========================================="
...
SAVE_DIR=${SAVE_DIR:-"checkpoints/superres_diff"}
...
echo "  kd_temp: $TEMP_INIT (final=${TEMP_FINAL:-constant})"
echo "  alpha_kd: $ALPHA_INIT (final=${ALPHA_FINAL:-constant})"
echo "  conf_weighted_kd: $CONF_WEIGHTED_KD"
echo ""

CMD="python SuperResDiff.py \
    --save_dir $SAVE_DIR \
    --run_name $RUN_NAME \
    --sr_mode $SR_MODE \
