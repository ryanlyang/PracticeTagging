...
"""
JetClass V2-Attr + m2-style HLT + simple three-operation reconstructor.
...
def main() -> None:
    ...
    jetlatent = importlib.import_module(
        "offline_reconstructor_joint_dualview_stage2save_auc_norankc_nopriv_unmergeonly_simple3_ops"
    )
    ...
    wrapper_parser.add_argument("--simple3_loss_w_axis", type=float, default=0.08)
    ...
    args.simple3_loss_w_axis = float(wrapper_args.simple3_loss_w_axis)
    jetlatent.configure_simple3_ops(loss_w_axis=float(args.simple3_loss_w_axis))
    ...
    def _compose_stagea_fullinfo_losses(
        ...
        *,
        ...
        losses_reco = jetlatent.compute_reconstruction_losses_weighted_simple3_ops(
            reco_out,
        ...
        for ep in tqdm(range(int(train_cfg["epochs"])), desc="Reconstructor"):
            ...
            if (ep + 1) % 5 == 0:
                print(
                    ...
                    f"simple3_axis_w={float(args.simple3_loss_w_axis):.3f}, "
    ...
    v2.OfflineReconstructor = jetlatent.OfflineReconstructorSimple3Ops
    v2.compute_reconstruction_losses_weighted = jetlatent.compute_reconstruction_losses_weighted_simple3_ops
    v2.build_soft_corrected_view = jetlatent.build_soft_corrected_view_simple3_ops
    ...
    reco_joint.compute_reconstruction_losses_weighted = jetlatent.compute_reconstruction_losses_weighted_simple3_ops
