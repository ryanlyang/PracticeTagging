...
#
# Usage:
#   sbatch run_train_jetclass_joint_dualview_confgen_v2attr_50k25k100k_v1hltplus25_stagea_teacherlogit_autoteacher_recoonlydual.sh
#
# Optional overrides:
#   RUN_NAME=... TEACHER_RUN_NAME=... N_TRAIN_JETS=... N_VAL_JETS=... N_TEST_JETS=... sbatch ...

#SBATCH --job-name=jcOffTA
#SBATCH --partition=tier3
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=64G
#SBATCH --time=24:00:00
#SBATCH --output=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_50k25k100k_v1hltplus25_stagea_teacherlogit_autoteacher_recoonlydual_%j.out
#SBATCH --error=offline_reconstructor_logs/jetclass_joint_dualview_confgen_v2attr_50k25k100k_v1hltplus25_stagea_teacherlogit_autoteacher_recoonlydual_%j.err
...
RUN_NAME="${RUN_NAME:-jetclass_joint_confgen_v2attr_50k25k100k_v1hltplus25_stagea_teacherlogit_autoteacher_recoonlydual}"
