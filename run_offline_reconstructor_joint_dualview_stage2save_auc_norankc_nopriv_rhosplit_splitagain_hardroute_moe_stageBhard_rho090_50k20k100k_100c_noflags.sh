#!/usr/bin/env bash
# Hard-route MoE variant with Stage B hard-routed as well.
# Same settings as the existing hardroute runner, but adds --stageB_hard_route.
#
# Submit:
...
RUN_NAME="${RUN_NAME:-joint_stage2save_auc_norankc_nopriv_rhosplit_splitagain_hardroute_moe_stageBhard_rho090_50k20k100k_100c_noflags}"
