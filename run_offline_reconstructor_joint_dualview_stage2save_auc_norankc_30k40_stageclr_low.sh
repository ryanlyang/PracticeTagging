#!/usr/bin/env bash
# 30k/40, AUC-selection, no Stage-C rank term, Stage-C LR reduced.
#SBATCH --job-name=offreco30lr
#SBATCH --partition=debug
#SBATCH --gres=gpu:1
#SBATCH --mem=48G
#SBATCH --time=1:00:00
#SBATCH --output=offline_reconstructor_logs/offline_reco_joint_30k40_lr_%j.out
#SBATCH --error=offline_reconstructor_logs/offline_reco_joint_30k40_lr_%j.err

set -euo pipefail

mkdir -p offline_reconstructor_logs

RUN_NAME="${RUN_NAME:-joint_30k_40c_auc_norankc_stageclr_low}"
